...
enum class UnicodeIndicSyllabicCategory(override val icuValue: Int) : UnicodeValueEnum<UnicodeIndicSyllabicCategory> {
    ...
    companion object : UnicodeValueEnum.CompanionImpl<UnicodeIndicSyllabicCategory>(
