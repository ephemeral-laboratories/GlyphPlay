...
enum class UnicodeIndicPositionalCategory(override val icuValue: Int) : UnicodeValueEnum<UnicodeIndicPositionalCategory> {
    ...
    companion object : UnicodeValueEnum.CompanionImpl<UnicodeIndicPositionalCategory>(
