...
enum class UnicodeLineBreak(override val icuValue: Int, val typeString: String) :
    IcuUnicodeValueEnum<UnicodeLineBreak> {
    ...
    companion object : IcuUnicodeValueEnum.CompanionImpl<UnicodeLineBreak>(
